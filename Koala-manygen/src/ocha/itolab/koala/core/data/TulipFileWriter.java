...
public class TulipFileWriter {
	...
	static ArrayList<ArrayList<Edge>> cedgelist;
	...
	public static void write(Graph graph) {
		...
		System.out.print("KoalaFileWriter: " + filename);
		...
		writeOneLine("  (default \"(1.0,1.0,0.0)\" )");
		writeOneLine(")");
	...
	static void setupEdges(Graph graph) {
		...
		cedgelist = new ArrayList<ArrayList<Edge>>();
